...
class RDVbank extends StatefulWidget {
  const RDVbank({Key? key}) : super(key: key);

  @override
  State<RDVbank> createState() => _RDVbankState();
}

class _RDVbankState extends State<RDVbank> {
  dynamic date;
  dynamic time;
  ...
  String? dropdownvalue = 'Ouvrir un compte';
  var items = [
    'Ouvrir un compte',
    'Autre',
  ...
  String? dropdownvalue3 = 'HaPoalim';
  var items3 = [
    'HaPoalim',
    'Leumi',
    'Discount',
      ...
      body: ListView(
        children: [
          ...
          Padding(
              ...
              child: Text('RDVbank'.tr, style: bigBoldWhiteStyle,)
          ),SizedBox(height: 5,),
          Padding(
            padding: const EdgeInsets.only(left: 40.0,right: 20),
            child: Text("SousTitreNewRequest".tr, style: smallWhiteStyle,),
          ),
                            ...
                            child: Padding(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (String? value3) {
                                    //get value when changed
                                    print("You have selected $value3");
                                    setState(() {
                                  ...
                                  Color(0xFF3A92E6), //Icon color
                                  style:smallBoldBlueStyle,
                                  dropdownColor: Color(0xFFCE881C),
                                  underline: Container(),
