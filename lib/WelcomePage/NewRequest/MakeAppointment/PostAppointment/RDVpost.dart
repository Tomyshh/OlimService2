...
class RDVpost extends StatefulWidget {
  const RDVpost({Key? key}) : super(key: key);

  @override
  State<RDVpost> createState() => _RDVpostState();
}

class _RDVpostState extends State<RDVpost> {
  dynamic date;
  dynamic time;
  ...
  String? dropdownvalue = 'Récuperer colis';
  var items = [
    'Récuperer colis',
    'Envoyer colis',
    'Payer ',
        ...
        body: ListView(
          children: [
            ...
            Padding(
                ...
                child: Text('RDVpost'.tr, style: bigBoldWhiteStyle,)
            ),SizedBox(height: 5,),
            Padding(
