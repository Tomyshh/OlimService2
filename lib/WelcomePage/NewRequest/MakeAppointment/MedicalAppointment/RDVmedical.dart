...
class RDVmedical extends StatefulWidget {
  const RDVmedical({Key? key}) : super(key: key);

  @override
  State<RDVmedical> createState() => _RDVmedicalState();
}

class _RDVmedicalState extends State<RDVmedical> {
  ...
  String? dropdownvalue = 'Medecin traitant';
  var items = [
    'Medecin traitant',
    'Gynecologue',
    'Ophtalmo',
  ...
  String? dropdownvalue3 = 'Doctor'.tr;
  var items3 = [
    'Doctor'.tr,
    'Gyneco'.tr,
    'Ophtalmo'.tr,
        ...
        body: ListView(
          children: [
            ...
            Padding(
                ...
                child: Text('RDVmed'.tr, style: bigBoldWhiteStyle,)
            ),SizedBox(height: 5,),
            Padding(
