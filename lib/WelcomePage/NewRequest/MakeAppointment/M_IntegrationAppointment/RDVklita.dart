...
class RDVklita extends StatefulWidget {
  const RDVklita({Key? key}) : super(key: key);

  @override
  State<RDVklita> createState() => _RDVklitaState();
}

class _RDVklitaState extends State<RDVklita> {
  dynamic date;
  dynamic time;
  ...
  String? dropdownvalue = 'Teoudat Zehout';
  var items = [
    'Teoudat Zehout',
      ...
      body: ListView(
        children: [
          ...
          Padding(
              ...
              child: Text("RDVklita".tr, style: bigBoldWhiteStyle,)
          ),SizedBox(height: 5,),
          Padding(
