...
class RDVbitahon extends StatefulWidget {
  const RDVbitahon({Key? key}) : super(key: key);

  @override
  State<RDVbitahon> createState() => _RDVbitahonState();
}

class _RDVbitahonState extends State<RDVbitahon> {
  dynamic date;
  dynamic time;
  ...
  String? dropdownvalue = 'Permis arme';
  var items = [
    'Permis arme',
    'Autre',
  ];
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text('TypeOfRDV'.tr, style: smallBoldBlueStyle),
                      ),
                      SizedBox(
                        width: 20,
                      ),
                          ...
                          child: Padding(
                            ...
                            child: DropdownButton(
                              ...
                              items: [
                                ...
                                DropdownMenuItem(
                                    child: Text(items2[1]), value: items2[1]),
                                DropdownMenuItem(
                                  child: Text(items2[2]),
                                  value: items2[2],
                                ),
                                DropdownMenuItem(
                                    child: Text(items2[3]), value: items2[3]),
                                DropdownMenuItem(
                                    child: Text(items2[4]), value: items2[4]),
                                DropdownMenuItem(
                                  child: Text(items2[5]),
                                  value: items2[5],
                                ),
