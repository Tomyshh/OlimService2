...
class LocaleString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'fr_FR': {
          ...
          'NotAbbo': 'Pas encore aboné ? Inscrivez-vous !',
          'Signup': 'Inscription',
          ...
          'AreYouSureToLeaveApp':"Êtes-vous sûre de vouloir quitter l'application ?",
          'Confirm':'Confirmer',
          'Cancel':'Annuler',
          'ExitSub':"Annuler l'inscription",
          'AreYouSureToLeaveSub':"Êtes-vous sûre de vouloir annuler l'inscription ?",
          'Start':"Commençons l'inscription",
          'ContratLoc':'Contrat de location',
          'FactureElec':"Facture d'éléctricité",
          'FactureArnona':"Facture d'arnona",
          'FactureGaz':"Facture de gaz",
          'Passeport':"Passeport",
          'Appartment':"Entré/sortie\nd'appartement",
          'SousTitreAppartment':"Olim mène à bien tout le processus conçernant votre appartement de l'entrée à la sortie",
        ...
        'en_US': {
          ...
          'ExitApp':"Exit App",
          'AreYouSureToLeaveApp':"Are you sure you want to leave the app?",
          'Confirm':'Confirm',
          'Cancel':'Cancel',
          'ExitSub':"Cancel Subscription",
          'AreYouSureToLeaveSub':"Are you sure you want to cancel subscription ?",
          'Start':"Let's start",
          'ContratLoc':'Rental contract',
          'FactureElec':"Electricity bill",
          'FactureArnona':"Arnona bill",
          'FactureGaz':"Gas bill",
          'Passport':"Passport",
          'Apartment':"Entering/leaving\napartment",
          'SousTitreAppartment': "Olim carries out the entire process concerning your apartment from entry to exit",
        ...
        'he_IL': {
          ...
          'AreYouSureToLeaveApp':"האם תרצה לצאת מהאפליקציה ?",
          'Confirm':'מאשר',
          'Cancel':'ביטול',
          'ExitSub': "בטל מנוי",
          'AreYouSureToLeaveSub':"האם אתה בטוח שאתה רוצה לבטל את המנוי?",
          'Start':"בוא נתחיל",
          'ContratLoc':'חוזה שכירות',
          'FactureElec':"חשבון חשמל",
          'FactureArnona': "חשבונית ארנונה",
          'FactureGaz':"חשבונית גז",
          'Passeport': "דרכון",
          'Appartment': "כניסה ויציאה לדירה",
          'SousTitreAppartment': "עולים מבצעים את כל התהליך הנוגע לדירתך מכניסה ליציאה",
        }
      };
}
